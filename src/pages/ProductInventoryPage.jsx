...
function GestionInventaireProduits() {
  ...
  const fetchInventoryData = async () => {
    ...
    try {
      ...
      // Filter out the row with productId "Article"
      const filteredData = response.data.filter(item => item.productId !== 'Article');
      // Assuming your backend returns a 'dailyTransactions' field for each product
